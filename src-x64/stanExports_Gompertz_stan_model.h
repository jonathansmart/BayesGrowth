...
class model_Gompertz_stan_model
  : public stan::model::model_base_crtp<model_Gompertz_stan_model> {
private:
        int n;
        vector_d Age;
        vector_d Length;
        ...
        vector_d priors_se;
public:
    model_Gompertz_stan_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Gompertz_stan_model_namespace::model_Gompertz_stan_model";
        ...
        try {
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                stan::model::assign(PredL, 
                            ...
                            (L0 * stan::math::exp((stan::math::log((Linf / L0)) * (1 - stan::math::exp((-(k) * get_base1(Age, i, "Age", 1))))))), 
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Gompertz_stan_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Gompertz_stan_model_namespace::model_Gompertz_stan_model stan_model;
#ifndef USING_R
