...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Logistic_stan_model");
    reader.add_event(56, 54, "end", "model_Logistic_stan_model");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Logistic_stan_model
  : public stan::model::model_base_crtp<model_Logistic_stan_model> {
private:
        int n;
        vector_d Age;
        vector_d Length;
        ...
        try {
            ...
            for (int i = 1; i <= n; ++i) {
                ...
                stan::model::assign(PredL, 
                            ...
                            (((Linf * L0) * stan::math::exp((k * get_base1(Age, i, "Age", 1)))) / (Linf + (L0 * (stan::math::exp((k * get_base1(Age, i, "Age", 1))) - 1)))), 
...
typedef model_Logistic_stan_model_namespace::model_Logistic_stan_model stan_model;
#ifndef USING_R
