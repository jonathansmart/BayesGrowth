...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 36, column 6 to column 85)",
                                                      ...
                                                      " (in 'string', line 28, column 4 to column 49)",
...
public:
  ...
  inline std::string model_name() const final { return "model_VB_stan_model"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_VB_stan_model_namespace::log_prob";
(void) function__;  // suppress unused var warning
      ...
      }
      {
        ...
        for (int i = 1; i <= n; ++i) {
          ...
          assign(PredL, cons_list(index_uni(i), nil_index_list()),
            (Linf - ((Linf - L0) * stan::math::exp((-k * Age[(i - 1)])))),
