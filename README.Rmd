...
If you need to install the package manually (skipping the compiling) you can go to the latest release and downloadthe package file ('BayesGrowth_ver.zip'). This can then be installed from Rstudio using Packages -> Install -> Package Archive File (.zip, tar.gz).
