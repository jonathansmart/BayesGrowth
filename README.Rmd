...
## Installation
This package provides a series of wrapper functions to the rjags package which will run JAGS ("Just Another Gibbs Sampler") MCMC models. Therefore, _JAGS must be installed before this package is installed_. To install JAGS, visit:
