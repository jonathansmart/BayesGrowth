...
```{r,echo = FALSE}
# The readme can't find the stand models so secretly change teh directory to avoid issues.
top_dir <- getwd()
knitr::opts_knit$set(root.dir = "C:/UserData/Documents/SARDI/Modelling and programming/R/Packages/BayesGrowth/inst/stan/")
...
```{r,echo = FALSE}
# Change the directory back to its original now the model has run
knitr::opts_knit$set(root.dir = top_dir)

```


The function returns the rstan outputs which is an object of class 'mcmc.list'
...
growth_curve <- Calculate_MCMC_growth_curve(results,
                                            Model = "VB",
